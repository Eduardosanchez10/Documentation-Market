...
export class AddMigrations1737732029525 implements MigrationInterface {
    name = 'AddMigrations1737732029525'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "is_active" boolean NOT NULL DEFAULT true, "name" character varying(100) NOT NULL, "birth_date" TIMESTAMP NOT NULL, "city" character varying(100) NOT NULL, "phone" character varying(100) NOT NULL, "email" character varying(100) NOT NULL, "note" character varying(100), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
